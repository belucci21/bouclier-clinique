...
export const SOURCE_TREATMENTS = Object.freeze([
  sourceTreatment({
    ...
    description: 'EXION Fracc, Control de Pulsos por Inteligencia Artificial. Dosifica la energía inteligente para limitar la percepción dolorosa. La energía es entregada únicamente desde la punta de la aguja. Hace una contracción y desnaturalización del colágeno viejo y fibras de elastina\n\nConduce a una fuerte remodelación del tejido que se ve como: Estiramiento de la piel, Corrección de tejido fibrótico como cicatrices, Mejora la textura de la piel, Trata las manchas de la piel.\n\nCicatrices por acné\nCicatrices por accidente\nCicatrices post operatorios\nCicatrices por quemaduras',
  ...
  sourceTreatment({
    ...
    description: 'La sinergia de las dos longitudes de onda de CO2+1540 nm también logra el calentamiento, adyacente y no coagulante de toda la zona de escaneo, y alcanza una gran profundidad dérmica.\n\nEl efecto térmico alcanza un nivel de profundidad que maximiza la acción de estimulación tisular y, por tanto, se obtiene un tratamiento aún más eficaz con tiempos de cicatrización reducidos.',
  ...
  sourceTreatment({
    ...
    description: 'Tratamiento 3 en 1: eliminación de grasa no deseada, celulitis y tensado de la piel. plataforma líder para remodelación corporal, se centra simultáneamente en la reducción de tejido graso, en la producción y mejora de colágeno y en la tonificación de la piel',
  ...
  sourceTreatment({
    ...
    description: 'Endermologie®, la única técnica 100 % natural, no invasiva y no agresiva de estimulación mecánica de la piel que permite reactivar el mecanismo de las células. Ejercita la piel y el tejido graso para suavizarlo y eliminar las acumulaciones fibrosas.\n\nSimultáneamente, la acción mecánica del cabezal de tratamiento estimula la eliminación natural de la grasa y reafirma la piel para devolverle su tonicidad y un aspecto más liso.',
  ...
  sourceTreatment({
    ...
    description: 'RedTouch es el primer sistema con absorción selectiva por parte del colágeno. La capa epidérmica no sufre daños, lo cual reduce los efectos secundarios del tratamiento. Es una nueva tecnología capaz de ofrecer al usuario sesiones de tratamiento no invasivas.\n\nIdeal para tratar: melasma, acné, rejuvenecimiento y rosácea.',
  ...
  sourceTreatment({
    ...
    description: 'Tratamiento del cuerpo por frotamiento, amasamiento, y percusión, tiene como finalidad activar el flujo de la sangre y la linfa, aumentar flexibilidad de los músculos, aliviar el cansancio o inducir el sueño.',
  ...
  sourceTreatment({
    ...
    description: 'Es técnica para tratar problemas crónicos musculares por debajo de las capas superficiales del músculo, produciendo un estado de relajación más profundo y duradero.',
