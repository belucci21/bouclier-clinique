...
import { Smartphone, Download, Apple, QrCode, Shield, Bell, Calendar } from 'lucide-react'
...
const clinicFeatures = [
  { icon: Calendar, title: 'Gestión del Día', desc: 'Visualiza todas las citas del día en tiempo real' },
  { icon: QrCode, title: 'Escáner QR', desc: 'Identifica pacientes al escanear su código' },
  { icon: Smartphone, title: 'Estados Rápidos', desc: 'Actualiza el estado de cada cita con un toque' },
  { icon: Shield, title: 'Pacientes', desc: 'Acceso rápido al historial de cada paciente' },
]
...
export default function Descargar() {
  return (
    <>
      ...
      <section className="page-hero">
        ...
        >
          ...
          <p className="page-hero__subtitle">
            Disponible para iOS y Android. Gestiona tus citas y salud desde tu celular.
          </p>
        </motion.div>
      </section>
      ...
      <AnimatedSection className="section">
        <div className="section__inner">
          <motion.div variants={fadeUp} style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '36px', fontWeight: 500, marginBottom: '12px' }}>
              App Paciente
            </h2>
          ...
          <motion.div variants={fadeUp} style={{ display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
            <a
              href="https://apps.apple.com/app/bouclier-paciente/id6748048993"
              target="_blank"
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.bouclier.patient"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: 'flex', alignItems: 'center', gap: '12px',
      ...
      {/* Divider */}
      <div style={{ height: '1px', background: 'linear-gradient(90deg, transparent, rgba(184,154,90,0.3), transparent)', margin: '0 auto', maxWidth: '800px' }} />
        ...
        <div className="section__inner">
          <motion.div variants={fadeUp} style={{ textAlign: 'center', marginBottom: '48px' }}>
            <div style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              margin: '0 auto 24px', border: '2px solid var(--color-accent)'
            }}>
              <Smartphone className="w-10 h-10" style={{ color: 'var(--color-accent)' }} />
            </div>
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '36px', fontWeight: 500, marginBottom: '12px' }}>
              App Clínica
            </h2>
            <p style={{ color: '#999', fontSize: '18px', maxWidth: '600px', margin: '0 auto' }}>
              Para doctores y personal de recepción. Gestiona el día desde tu celular.
            </p>
          </motion.div>

          {/* Features Grid */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px', marginBottom: '48px' }}>
            {clinicFeatures.map(({ icon: Icon, title, desc }, i) => (
              <motion.div key={i} variants={fadeUp} style={{
                background: 'rgba(255,255,255,0.03)', borderRadius: '16px', padding: '24px',
                border: '1px solid rgba(255,255,255,0.05)'
              }}>
          ...
          <motion.div variants={fadeUp} style={{ display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
            <a
              href="https://apps.apple.com/app/boucliner-clinica/id6748049125"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: 'flex', alignItems: 'center', gap: '12px',
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.bouclier.clinic"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: 'flex', alignItems: 'center', gap: '12px',
